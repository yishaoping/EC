...
static inline void debug_bp_reset(void)
{
  ROCC_INSTRUCTION (1, 0x2d);
}

static inline uint64_t debug_bp_checker(void)
{
  uint64_t bp_checker;
...
static inline uint64_t debug_bp_cdc(void)
{
  uint64_t bp_cdc;
...
static inline uint64_t debug_bp_filter(void)
{
  uint64_t bp_filter;
...
{
  // Core x's packets
  uint64_t mask = core_id << 3;//1000 10000 11000 100000
